...
@section('title', 'Reports | Sales Report')
                ...
                <div class="card-header d-flex align-items-center justify-content-between">
                    ...
                    @if($reports->count() > 0)
                        @if(isset($_GET['from']) && isset($_GET['to'])) 
                            <a href="/reports/export/sales-report/{{$_GET['from']}}/{{$_GET['to']}}" class="btn btn-sm text-light d-flex align-items-center"><i class="fas fa-file-export mr-2"></i><span>Export</span></a>
                        @else
